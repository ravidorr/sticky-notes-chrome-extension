...
- Restore iframe support for sticky notes
  - Added `allFrames: true` to programmatic content script injection
  - Notes can now be created and displayed in iframes again
